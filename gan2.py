...
PATH_G = os.path.abspath(os.path.curdir) + "\\state\\gan2\\generator.pth"
PATH_D = os.path.abspath(os.path.curdir) + "\\state\\gan2\\discriminator.pth"
...
class Generator(nn.Module):
    def __init__(self):
        ...
        self.model = nn.Sequential(
            *block(opt.latent_dim, 600, normalize=False),
            *block(600, 1200),
